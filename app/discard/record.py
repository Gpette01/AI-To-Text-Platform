...
class Thesis(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = qtgui.Range(0, 60, 1, 10, 200)
        self._gain_win = qtgui.RangeWidget(self._gain_range, self.set_gain, "'gain'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._gain_win)
        self._fc_range = qtgui.Range(50e6, 200e6, 200e3, 94.8e6, 200)
        ...
        self.blocks_wavfile_sink_1 = blocks.wavfile_sink(
            '/home/gpette/UCY/Thesis/test/file.wav',
            1,
            48000,
            blocks.FORMAT_WAV,
        ...
        self.connect((self.analog_wfm_rcv_0, 0), (self.blocks_wavfile_sink_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.fc, (self.samp_rate/5))
