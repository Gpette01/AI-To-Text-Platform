...
import Thesis_epy_block_0 as epy_block_0  # embedded python block
import Thesis_epy_block_1 as epy_block_1  # embedded python block
import osmosdr
import time
...
class Thesis(gr.top_block, Qt.QWidget):

    def __init__(self, device=0, fc=446.03125e6, file='/home/ubuntulaptop/Desktop/distanceTest.wav'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Thesis")
        ...
        self._ppm_range = Range(0, 30, 1, 22, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_KAISER,
                6.76))
        self.epy_block_1 = epy_block_1.blk(file=file)
        self.epy_block_0 = epy_block_0.complex_threshold(low_threshold=0.15)
    ...
    def set_file(self, file):
        self.file = file
        self.epy_block_1.file = self.file
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, (-self.bw/2), (+self.bw/2), 10e3, window.WIN_KAISER, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 5e3, 1e3, window.WIN_KAISER, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(self.fc, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.fc, self.samp_rate)
        self.qtgui_freq_sink_x_1.set_frequency_range(0, (self.samp_rate/5/10))
...
def argument_parser():
    ...
    parser.add_argument(
        "--device", dest="device", type=intx, default=0,
        help="Set device [default=%(default)r]")
    parser.add_argument(
        "--fc", dest="fc", type=eng_float, default=eng_notation.num_to_str(float(446.03125e6)),
        help="Set fc [default=%(default)r]")
    parser.add_argument(
        "--file", dest="file", type=str, default='/home/ubuntulaptop/Desktop/distanceTest.wav',
        help="Set file [default=%(default)r]")
    return parser


def main(top_block_cls=Thesis, options=None):
    if options is None:
    ...
    tb = top_block_cls(device=options.device, fc=options.fc, file=options.file)
