...
class Thesis(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, fc=446.03125e6, file='/home/ubuntulaptop/Desktop/distanceTest.wav'):
        ...
        self._ppm_range = Range(0, 30, 1, 27, 200)
...
def main(top_block_cls=Thesis, options=None):
    ...
    tb = top_block_cls(fc=options.fc, file=options.file)
